...
<div class="hero">
    ...
    <p>
        An AI-powered public health early-warning and response
        system for ASEAN. HealthPulse AI combines health risk
        scoring, system readiness, machine learning and
        actionable recommendations to identify where
...
if page == "Executive Overview":
    ...
    average_readiness = (
        latest_df["readiness_score"].mean()
    )

    high_risk_count = (
        latest_df["health_risk_level"]
        == "High"
    ).sum()
    ...
    # Ascending data + reversed y-axis places highest value at top
...
# ============================================================
    ...
    with right_column:
        ...
        # Percentage labels shown inside slices
...
# ============================================================
    ...
    with right_column:
        # Ascending data + reversed axis puts highest count at top
        priority_counts = (
